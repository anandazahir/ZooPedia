...
import HabitInfo from "./Component/HabitInfo";
import SocInfo from "./Component/SocInfo";
          ...
          <Container className="d-flex  justify-content-center">
            ...
            >
              <Container className="d-flex flex-row justify-content-between">
                ...
                <Card.Title className="mt-3 h5 text-center text-white">
              ...
              {/* HabitInfo */}
              <HabitInfo animal={animal} />
              {/* SocInfo */}
              <SocInfo animal={animal} />
            </Card>
          </Container>
        )}
      </Container>
